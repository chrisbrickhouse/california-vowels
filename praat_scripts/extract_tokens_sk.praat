...
form Find tokens and save them
   ...
   text sound_directory /home/cj/ling/QP2/wordlists/
   comment Directory of TextGrid files
   text textGrid_directory /home/cj/ling/QP2/wordlists/
   comment Specify the folder of the resulting files:
   text folder /home/cj/ling/QP2/potential_tokens/
   
 	comment Which tier? 
		integer tier_number 1
	comment Which segment?
		sentence segment AE1
	comment Previous enviroment:
		choice  previous 1
			button anything
			button coronals
			button non-coronals
	comment following enviroment:
		choice  following 3
			button anything
			button nasals
			button non-nasals
...
for ifile to numberOfFiles
	...
	for label from 2 to nlabels - 1
		...
		if label_name$ = "'segment$'"
			...
			filename$ = "'folder$'" + "'soundname$'" + "_" + "'segment$'" + "_" + "'word_start'" + "_" + "'word$'"
